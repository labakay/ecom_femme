		...
		<div class='col-md-8'>
			<div class="panel panel-default">
  				...
  				<div class="panel-body">
    				Hello <?php echo $_SESSION['f_name']; ?>, Votre payement à été validé.
    				<br>continuer votre shoping nous vous recontacterons .
    				<p></p>
    				<a href="profile.php" class='btn btn-success btn-lg'>Retour à la page </a>
  				</div>
			</div>
		<div class='col-md-2'></div>
	</div>
